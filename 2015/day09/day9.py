...
def part1(paths):
    ...
    # for route in itertools.permutations(places, len(places)):
    #     route_length = sum(distances[pair(place_1, place_2)] for place_1, place_2 in pairwise(route))
    #     print(' -> '.join(route) + f" = {route_length}")
